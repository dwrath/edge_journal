            ...
            <section className="auth-right-section">
                <div className="z-10 relative lg:mt-4 lg:mb-16">
                    <blockquote className="auth-blockquote">
                        Edge Journal turned my watchlist into a winning list. The alerts are spot-on, I can track my trading, and I feel more confident making moves in the market.
                    </blockquote>
